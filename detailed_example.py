...
TOKEN ='665670808:AAHswU9kHoHZ5AcAglqr0PmrFNIuYq-wOXY'
...
# filter on a specific message
@bot.message_handler(func=lambda message: message.text == "Oneyni ami" or message.text=="oneyni ami")
def command_text_hi(m):
    bot.send_message(m.chat.id, "O'zini oneyni ami, qanju! "+ f'{m.chat.first_name} Jalab!')
